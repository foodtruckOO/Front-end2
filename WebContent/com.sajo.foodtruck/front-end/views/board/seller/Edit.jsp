				...
				<div class="body">
					<div class="content">
						<fieldset style="padding: 20px 0 50px 20px">
							...
							<form action="<c:url value='/SellerEditCheck.board?sb_no=${adidas.sb_no }'/>" method="post">
								<table width="75%" bgcolor="gray" cellspacing="1">
									<tr bgcolor="white">
										<td width="30%" align="center">제목</td>
										<td><input class="form-control" name="title" style="width: 98%" value=" ${adidas.title }" />
										
										</td>
									</tr>
									<tr bgcolor="white">
										<td align="center">내용</td>
										<td><textarea class="summernote" rows="10" style="width: 98%" name="content" >${adidas.content }</textarea></td>
									</tr>
