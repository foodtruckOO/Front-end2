							...
							<form action="<c:url value='/sale.board?sb_no=${adidas.sb_no }'/>" method="post">
								<table width="75%" bgcolor="gray" cellspacing="1">
									<tr bgcolor="white">
										...
										<td><input type="text" name="title" style="width: 98%" value=" ${adidas.title }" />
										
										</td>
									</tr>
									<tr bgcolor="white">
										<td align="center">내용</td>
										<td><textarea rows="10" style="width: 98%" name="content" >${adidas.content }</textarea>
