		...
		<div class="col-md-4" style="margin-bottom: 20px;">
			...
			<div data-toggle="modal" data-target="#menuModal${loop.count }" style="cursor: pointer;">
				...
				<div style="display: block; padding-top: 100%; position: relative;">
					<img src="http://localhost:8080/Front-end_FoodTruckProj/seller/api/EVENT/TITLE/${list.newPicture }" alt="이미지를 찾을 수 없습니다.."
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        ...
		        <div style="width: 100%; display: block; padding-top: 60%; position: relative;">
	        		<img src="http://localhost:8080/Front-end_FoodTruckProj/seller/api/EVENT/CONTENT/${list.newPicture}" alt="이미지를 찾을 수 없습니다.."
