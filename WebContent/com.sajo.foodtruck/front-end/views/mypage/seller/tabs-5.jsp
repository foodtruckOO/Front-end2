...
<form>
	<div style="width: 49.5%; float: left; padding: 5%; padding-top: 0%;">
		...
		<div class="form-group">
			...
			<input class="form-control" id="" placeholder="010-0123-4567">
		</div>
		<div class="form-group" >
			<label for="">주소</label>
			<input class="form-control" id="" placeholder="서울특별시 강남구 대치1동 남부순환로 ２９４２ " style="position: relative; width: 200%">
			<button type="submit" class="btn btn-default" style="margin-left: 203%;">주소</button>
			<br/>
			<input class="form-control" id="" placeholder="서울특별시 강남구 대치1동 남부순환로 ２９４２ ">
		</div>
	</div>
	...
	<div style="width: 49.5%; float: right; padding: 5%; padding-top: 0%;">
		...
		<div class="form-group">
			...
			<input class="form-control" id="" placeholder="402-80-27740">
		</div>
		<div class="form-group">
			<label for="">점포명</label>
			<input class="form-control" id="" placeholder="SHEEPGOLD TRUCK">
		</div>
	</div>
