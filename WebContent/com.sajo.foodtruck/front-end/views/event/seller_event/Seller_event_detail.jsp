...
<html lang="ko">
  <head>
	...
	<script>
	function re(){
		location.href="<c:url value='/SellerEvent.event'/>";
	}
	function go(){
		var s_no = "${dto.s_no}"
		
		location.href="<c:url value='/detail1.foodtruck?s_no="+s_no+"'/>"
...
<body>
	...
	<div class="container-fluid">
		...
		<div class = "row">
			...
			<div class="col-md-8">
				<img class ="img-responsive" src="http://${dto.ip}:8080/Front-end_FoodTruckProj/seller/${dto.id}/EVENT/CONTENT/${dto.contentfile}"/>
			</div>
		...
		<div class = "row" style = "padding-top:50px;padding-bottom: 50px">
			<div class = "col-md-offset-3 col-md-3">
				<button class="btn btn-info btn-lg btn-block" type="button" onclick="javascript:go()">
								메뉴보기</button>
			</div>
