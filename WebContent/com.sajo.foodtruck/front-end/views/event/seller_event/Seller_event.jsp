		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12">
				<div class="jumbotron" style="background-color: white !important;">
					...
					<h2 style="display: inline; line-height: 150%">푸드트럭별 이벤트</h2>
				</div>
			</div>
		</div>
	<%-- 	<div class="row">
			...
			<div class="taste_card col-sm-4 col-xs-6 ">
						<div class="card_img_wrap" style="position: relative;">
							<div class="card_img_wrap_thumbnail a">
								<a href="<c:url value='/SellerEventview.event?s_no=${dto.s_no}'/>"><img
									src="http://${dto.ip}:8080/Front-end_FoodTruckProj/seller/${dto.id}/EVENT/TITLE/${dto.titlefile}"
									width="100%" /> </a>
							</div>
						</div>
