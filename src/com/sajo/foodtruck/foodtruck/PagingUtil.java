...
public class PagingUtil {
	...
	public static String pagingBootStrapStyle(int totalRecordCount,int pageSize,int blockPage,int nowPage,String page,String s_no){
		...
		if(intTemp != 1){
			pagingStr+="<li>\r\n" + 
					...
					"</li>\r\n" + 
					"<li >\r\n" + 
					"<a href='"+page+"nowPage="+(intTemp -blockPage)+"&s_no="+s_no+"'>\r\n" + 
		...
		while(blockCount <= blockPage && intTemp <= totalPage){  // 페이지 오버 를 체크
			...
			if(intTemp == nowPage){  
				pagingStr+="<li><a href='#'><span style='Color:red'>"+intTemp+"</span></a></li>";
		    	 ...
		    	 pagingStr+="<li><a href='"+page+"nowPage="+intTemp+"&s_no="+s_no+"'>"+intTemp+"</a></li>";
		...
		if(intTemp <= totalPage){
			pagingStr+="<li>\r\n" + 
					"<a href='"+page+"nowPage="+intTemp+"&s_no="+s_no+"'>\r\n" + 
					"<span aria-hidden=\"true\">&rsaquo;</span>\r\n" + 
					"</a>\r\n" + 
					"</li>\r\n" + 
					"<li>\r\n" + 
					"<a href='"+page+"nowPage="+totalPage+"&s_no="+s_no+"' >\r\n" + 
